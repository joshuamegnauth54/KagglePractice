...
rf_model_preproc <- train(x = X_train,
                          ...
                          metric = "ROC")
```
My second random forests model preprocesses the variables by scaling numeric features and applying principal component analysis.
