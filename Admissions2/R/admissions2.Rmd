...
# List of the above calculations to pass to ggroc
...
ggroc(roc_list) +
  ...
  ylab("Sensitivity") +
  ggtitle("ROC curves") +
  scale_color_discrete(labels = c("Logistic (unscaled)",
                                  "Random forest (unscaled)",
                                  "Random forest (scaled)",
                                  "Logistic (feature engineering)",
                                  "Random forest (feature engineering)"))
